...
if hasfound == 0:
    ...
    print hours + ":" + minutes
    subprocess.call(['osascript', '-e', 'tell application "System Events" to tell every desktop to set picture to "wallpapers/mojave-'+hours+'-'+minutes+'.jpeg"'], stdin=PIPE, stdout=PIPE, stderr=PIPE)
